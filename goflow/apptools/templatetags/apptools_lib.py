...
def input_buttons(context):
    ...
    if 'ok_values' in context: sub_context['ok_values'] = context['ok_values']
    if 'save_value' in context: sub_context['save_value'] = context['save_value']
    if 'cancel_value' in context: sub_context['cancel_value'] = context['cancel_value']
    return sub_context
